...
const productNamesToUpperCase = products.map(products => products.name.toUpperCase());
...
const totalInventoryValue = products.reduce(function(acc, product) {
  if (product.inStock) {
...
// ============================================
 ...
 console.log("Uppercased names:", productNamesToUpperCase);
